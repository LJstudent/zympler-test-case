...
export const GridColor = "fill-grid stroke-grid text-grid bg-grid/(--bg-opacity) bg-grid-500/(--bg-opacity)";
export const GridNegativeColor = "fill-grid-700 stroke-grid-700 text-grid-700 bg-grid-700/(--bg-opacity) bg-grid-700/(--bg-opacity)";
export const SolarColor = "fill-solar stroke-solar text-solar bg-solar/(--bg-opacity)";
export const SolarNegativeColor = "fill-solar-700 stroke-solar-700 text-solar-700 bg-solar-700/(--bg-opacity)";
export const BatteryColor = "fill-battery stroke-battery text-battery bg-battery/(--bg-opacity)";
export const BatteryNegativeColor = "fill-battery-700 stroke-battery-700 text-battery-700 bg-battery-700/(--bg-opacity)";
export const ChargerColor = "fill-charger stroke-charger text-charger bg-charger/(--bg-opacity)";
export const ChargerNegativeColor = "fill-charger-700 stroke-charger-700 text-charger-700 bg-charger-700/(--bg-opacity)";
...
export const GeneratorColor = "fill-generator stroke-generator text-generator bg-generator/(--bg-opacity)";
export const UnknownColor = "fill-slate-400 stroke-slate-400 text-slate-400 bg-slate-400/(--bg-opacity)";
export const GreenColor = "fill-green-600 stroke-green-600 text-green-600 bg-green-600/(--bg-opacity)";
export const RedColor = "fill-red-600 stroke-red-600 text-red-600 bg-red-600/(--bg-opacity)";
export const OrangeColor = "fill-orange-500 stroke-orange-500 text-orange-500 bg-orange-500/(--bg-opacity)";
export const FromWindColor = "fill-cyan-600 stroke-cyan-600 bg-cyan-600/(--bg-opacity)"
export const CurtailedSolarColor = "fill-slate-300 stroke-slate-300 text-slate-400 bg-slate-300/(--bg-opacity)";
